...
скилле `seo-cluster` (`skills/seo-cluster/SKILL.md`) — прочитай её (Read) и
...
## Контроль скоупа
Перед изменениями 3+ файлов или сменой структуры кластера / URL-схемы —
обязательная остановка по шаблону «А делаю, B/C нет». Не переразбивай уже
живущие кластеры если просили только новый pillar.
